...
<s:token />
    ...
    <script type="text/javascript" src="${ctx}/js/backstage/DateItem.js"></script> 
</head>
<body>
    ...
    <table width="950" height="97">  
              <tr > 
                                ...
                                <tr > 
                                    ...
                                    <td align="left">
                                      <textarea rows="3" cols="60" name="remark" id="remark"  maxlength="35"  onkeyup="if(value.length>35) value=value.substr(0,35)" value=value.substr(0,35)" style="overflow:hidden"></textarea>
                                    </td>
                                </tr>
       ...
       <table width="950" >
	     <tr>
		      ...
		      <td align="center" width=30%>日期类别</td>
		    ...
		    <tr>
			    ...
			    <td  align="center" width=40%>${remark}</td>
			     <td  align="center" width=20%>
			    	<a href="javascript:edititem('${ditemid}','${itemname}','${remark}');">修改</a> &nbsp; 
					  <a href="javascript:deleteitem('${ditemid}');">删除</a>
			     </td>
		    </tr>
		   </s:iterator>
		   <tr>
