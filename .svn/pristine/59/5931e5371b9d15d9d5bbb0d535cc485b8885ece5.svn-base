...
<title>角色配置权限完成</title>
<script type="text/javascript" src="<%=basePath%>js/jQuery/jquery-1.9.0.js"></script>

<script type="text/javascript" src="<%=basePath%>js/security/role/mapOK.js"></script>
<!-- 
<script type="text/javascript" src="<%=basePath%>js/alert.js"></script>
 -->
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/security/role/mapOK.css">
