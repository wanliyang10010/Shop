window.alert =function(content){   
        ...
        mask.style.height=(document.body.scrollHeight)*1.2+"px";
        mask.style.zIndex=1000;
        document.body.appendChild(mask);
        var temp="<div id=\"msg\" style=\"width:350px;border: 2px solid #37B6D1;background-color: #fff; font-weight: bold;font-size: 12px;\" >"
