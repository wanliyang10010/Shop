...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/backstage/DateRule.js"></script> 
</head>
<body>
    ...
    <table width="950" height="97" oncontextmenu=return(false)>
                              <tr > 
                                     <td align="right" width="25%">
                                        <label for="textfield">日期类别：</label>
                                    </td>
                                    <td align="left">
                                         <select name="rule" id="rule">
                                         <option value="请选择">请选择</option>   
							        <c:forEach items="${sessionScope.DateItemList}" var="dateitem">
								     <option value="${dateitem.itemname}">${dateitem.itemname}</option>
							        </c:forEach>
			                            </select>
                                    </td>
                                </tr>          
                                 <tr> 
                                     <td align="right">
                                        <label for="textfield">天数(天)：</label>
                                    </td>
                                    <td align="left">
                                 ...
                                 <tr style="display:none"> 
                                    ...
                                    <td align="left">
                                        <input type="number" name="dateId" id="dateId" >
                                    </td>
                                </tr>
                                <tr>
                                <tr>
      ...
      <c:if test="${page.pageSize>0}">                          
       <table width="950" >
	     <tr>
		      ...
		      <td align="center" width=30%>时限名称</td>
		      <td align="center" width=10%>天数(天)</td>
		   ...
		   <s:iterator value="#request.page" status="s">
		    <tr>
			    ...
			    <td  align="center">${count}</td>
			     <td  align="center">
			    	<a href="javascript:editmargin('${dateId}','${rule}','${count}');">修改</a> 
			     </td>
		    </tr>
	     </s:iterator>
	     <tr>
