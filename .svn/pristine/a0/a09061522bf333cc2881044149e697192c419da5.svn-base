...
<script type="text/javascript" src="${ctx}/js/returnGoods/applyReturn.js"></script>
</head>
<body>
		...
		<form name="userform" action="" id="userform">
			...
			<s:if test="#request.orderid!=''">
		     <table width="900px" align="center">
					...
					<button id="btn_apply" type="button" style="width:100px;"
							onclick="applyReturn();">申请退货</button></td>
				...
				<tr >
					<td align="center">
					<span style="color:#FF0000">*</span>申请理由：<input type="text" name="reason" id="reason" size="90" maxlength="33"></td>
				</tr>
				<tr>
					<td align="center" >
