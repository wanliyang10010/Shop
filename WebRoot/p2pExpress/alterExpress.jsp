...
<script type="text/javascript" src="${ctx}/js/p2pExpress/alterExpress.js"></script>
</head>
<body>
		...
		<form name="userform" action="" id="userform" enctype="multipart/form-data">
			...
			<thead>
				<tr style="background:#BFDBEB;font-weight:bold;font-size:13px">	
					<td align="center" width=13%>发件人地址</td>
					<td align="center" width=12%>收件人地址</td>
					<td align="center" width=10%>发布时间</td>
					<td align="center" width=10%>物品重量</td>
			...
			<tbody>
				<tr>					
					...
					<a href="javascript:deleteexpress('${expressId}');">删除</a>
					</td>								
				</tr>
			</tbody>
			</s:iterator>	
			...
			<div id="msg_searchAlterList">
				<font color="red" id="font1">${msg_searchAlterList}</font>
			</div>
		</form>
	</center>
	</div>
