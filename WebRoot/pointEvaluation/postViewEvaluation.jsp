...
<script type="text/javascript" src="${ctx}/js/pointEvaluation/postViewEvaluation.js"></script>
						...
						<div class="col-md-10 col-xs-12">
							...
							<div class="row">
								...
								<div class="col-md-10">
									...
									<div class="col-md-12 text-center"  style="margin-top: 10px;">
									 <table class="table-responsive " style="border:none;width:100%;height:100%;border-spacing: 0px">
										<tr>
											...
											<img id="imgFromSellY" src="${ctx}/image/evaluation/fromSellY.png" style="CURSOR: pointer;" /> 
											<img id="imgFromSellN" src="${ctx}/image/evaluation/fromSellN.png" onclick="img2('${userid}');" style="CURSOR: pointer;display:none" />
											</td>
											<td align="center" style="width:110px" colspan="1">
									...
									<table class="table-responsive " id="tbFromSell" style="width:100%;height:100%;border-spacing: 0px"> 
										<tr>
											<td>
												<s:if test="#request.page!= null&&#request.page.getTotalItems()>0">
													...
													style='width:100%;height:100%;border-spacing: 0px;word-wrap:break-word;word-break:break-all'>
														...
														<s:iterator value="#request.page" status="s">
															<tr>
																<td align="center">${checkIdea}</br>[${checkTime}]
																	<textarea name="addcontent${goodsEvaluationId}"
																		id="addcontent${goodsEvaluationId}" maxlength="333"
																		style="margin-top: 5px;width:100%;height:50px;display:none"></textarea>
																	<br/>
																	<img id="imgFromSellPublishReply${goodsEvaluationId}"
																	src="${ctx}/image/evaluation/publishReply.png"
																	onclick="publishreplyfromsell('${goodsEvaluationId}');" 
																	style="display:none;" />
																</td>
																<td align="center">
																	${userinfo.username}
																...
																<td align="center">
																	...
																	<img id="imgFromSellReply${goodsEvaluationId}" 
																	src="${ctx}/image/evaluation/reply.png" 
																	onclick="replyfromsell('${goodsEvaluationId}');"/>
																	</s:if>
																</td>
