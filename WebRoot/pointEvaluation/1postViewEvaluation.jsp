			...
			<table width="800px" align="center" colspan="8" id="">
				...
				<tr>
					<td align="center" style="width:110px;" colspan="1"><img
						...
						style="CURSOR: pointer;display:none" /> <img id="imgFromBuyN"
					...
					<td align="center" style="width:120px" colspan="1"><img
						...
						onclick="img2('${userid}');" style="CURSOR: pointer;display:none" /></td>
					<td align="center" style="width:110px" colspan="1"><img
						id="imgToOtherY" src="${ctx}/image/evaluation/toOtherY.png"
						style="CURSOR: pointer;display:none" /> <img id="imgToOtherN"
						src="${ctx}/image/evaluation/toOtherN.png" onclick="img3('${userid}');" 
						style="CURSOR: pointer"/></td>
					<td align="center" style="width:460px" colspan="5"></td>
				</tr>
			</table>
			<table width="800px" align="center" id="tbFromSell" style="word-wrap:break-word;word-break:break-all">
				<tr>
					<td>
							...
							<table width="800px" align="center" class="table" style="word-wrap:break-word;word-break:break-all">
								...
								<s:iterator value="#request.page" status="s">		
									<tr>
										...
										<img
											id="imgFromSellReply${goodsEvaluationId}"
