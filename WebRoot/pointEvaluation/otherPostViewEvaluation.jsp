...
<script type="text/javascript"	src="${ctx}/js/pointEvaluation/otherPostViewEvaluation.js"></script>
						...
						<div class="col-md-10 col-xs-12">
							...
							<div class="row">
								...
								<div class="col-md-10">
									...
									<table class="table-responsive " id="tbToOther" style="width:100%;height:100%;border-spacing: 0px"> 
										<tr>
											<td>
												<s:if test="#request.page!= null&&#request.page.getTotalItems()>0">
													...
													style='width:100%;height:100%;border-spacing: 0px;word-wrap:break-word;word-break:break-all'>
														<tr style="background:#BFDBEB;">
															...
															<td align="center" width=25%><B>被评价店铺</B></td>
														...
														<s:iterator value="#request.page" status="s">
															<tr>
																...
																<span class="lb-paddingtop-fontnormal">[追加评论]</span>
																<span id="lbfrombuy" class="lb-paddingtop-fontnormal" style="color:#BD7F00">${addcontent}</br>[${addTime}]</span>
																</s:if>
																</td>
																<td align="center">
																	<a href="${ctx}/viewProductAction_shop.do?shopid=${shop.shopId}" target="_blank">${shop.shopname}</a>
																</td>
																<td align="center">
