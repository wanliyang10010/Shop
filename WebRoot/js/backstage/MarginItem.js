...
function deleteitem(id)
  {
       ...
       document.form1.action= ctx+"/marginItemAction_delete.action"; 
  ...
  function add()
  {
      if(judgeNull())
     {
       document.form1.action= ctx+"/marginItemAction_add.action"; 
       document.form1.submit(); 
       }
  }
   ...
   function update()
  {
   if(judgeNull())
     {
       document.form1.action= ctx+"/marginItemAction_update.action"; 
       document.form1.submit(); 
       }
  }
  ...
  function search()
  {
     ...
     document.form1.action= ctx+"/marginItemAction_list.action"; 
     document.form1.submit();  
  }
