...
<script type="text/javascript"	src="${ctx}/My97DatePicker/WdatePicker.js"></script>
 <script type="text/javascript" src="${ctx}/js/shopManage/adminViewShopProgress.js"></script> 
    ...
    <div class="result-wrap">
	    ...
	    <input type="hidden"  name="page.pageSize" id="pageSize" value="${page.pageSize}"/> 
	   	<table width="950px">
			...
			<table width="950px" colspan="2" border="1"
				...
				<tr>
					...
					<td align="left"><img id="userpicturepicture"
						...
						src="<%=request.getContextPath()%>/image/download/middle.png" /></td>
				</tr>
				<tr>
			...
			<table width="950px" id="tbHidden" style="display: none">
				<tr>
					<td align="center">
