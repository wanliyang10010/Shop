...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/backstage/PointsItem.js"></script> 
</head>
<body>
    ...
    <table width="950" height="97">
              <tr > 
                                     <td align="right" width="20%">
                                        <label for="textfield">积分类别：</label>
                                    </td>
                                    <td align="left">
                                ...
                                <tr > 
                                    ...
                                    <td align="left">
                                      <textarea rows="4" cols="60" name="remark" id="remark"  maxlength="35"  onkeyup="if(value.length>35) value=value.substr(0,35)" value=value.substr(0,35)" style="overflow:hidden"></textarea>
                                    </td>
                                </tr>
 ...
 <c:if test="${page.pageSize>0}"> 
       <table width="950">
	     <tr>
		      ...
		      <td align="center" width=30%>积分类别</td>
		    ...
		    <tr>
			    ...
			    <td  align="center" width=40%>${remark}</td>
			     <td  align="center" width=20%>
			    	<a href="javascript:edititem('${pitemid}','${itemname}','${remark}');">修改</a> &nbsp; 
					  <a href="javascript:deleteitem('${pitemid}');">删除</a>
			     </td>
		    </tr>
	  	     </s:iterator>
	  	     <tr>
