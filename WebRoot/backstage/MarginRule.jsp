...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/backstage/MarginRule.js"></script> 
</head>
<body>
	...
	<script type="text/javascript">
	  ...
	  <input type="hidden" name="page.pageSize" id="pageSize" value="${page.pageSize}"/>
			<table width="950" height="97" oncontextmenu=return(false)>
				<tr>
					<td align="right" width="25%"><label for="textfield">商铺类型：</label></td>
					<td align="left" width="25%"><select name="type" id="type">
							<option value="请选择">请选择</option>
							<option value="个人一般店铺">个人一般店铺</option>
							<option value="个人旗舰店铺">个人旗舰店铺</option>
							<option value="企业一般店铺">企业一般店铺</option>
							<option value="企业旗舰店铺">企业旗舰店铺</option>
					</select></td>
					
					<td align="right" width="25%"><label for="textfield">商品类别：</label></td>
				...
				<tr>
					<td align="right"><label for="textfield">保证金额(元)：</label></td>
					<td align="left"><input type="text" name="money" id="money" maxlength="6"
				...
				<tr style="display:none">
					...
					<td align="left"><input type="number" name="marginruleId"
						id="marginruleId"></td>
				</tr>
			</table>
			<div>
       ...
       <table width="950">
	     <tr>
	          ...
	          <td align="center" width=20%>店铺类型</td>
		      <td align="center" width=30%>商品类别</td>
		      <td align="center" width=10%>保证金额(元)</td>
		    ...
		    <tr>
			    ...
			    <td  align="center" width=30%>${product}</td>
			    <td  align="center" width=10%>${money}</td>
			     <td  align="center" width=20%>
			    	<a href="javascript:editmargin('${marginruleId}','${type}','${product}','${money}');">修改</a>
			     </td>
		    </tr>
	    	   </s:iterator>
	    	   <tr>
