                            ...
                            <table width="950" border="1">
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left">
                                     <a href="javascript:vieworder('${dispute.order.ordersonId}');">${dispute.orderson}</a>
                                       </td>
                                </tr>
                                 <tr>
                                    <td align="right" style=" width:30%" >
          ...
          <c:if test="${dispute.state=='0'}">
	        ...
	        <tr>
                                    ...
                                    <td align="left" width:80%">
                                       <textarea rows="4" cols="60"  maxlength="50"  onkeyup="if(value.length>50) value=value.substr(0,50)" name="result" id="result" style="overflow:hidden"></textarea>
                                       </td>
                                </tr>
                                <tr id="check">
                                 <td colspan="2" align="center"> 
                                   <input type="button" name="btn_submit" id="btn_submit" value="提交" onclick="check();" >
                                    &nbsp;&nbsp;&nbsp;&nbsp;  
