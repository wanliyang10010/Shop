...
<script type="text/javascript" src="${ctx}/js/prolongTime/prolongSeller.js"></script>
</head>
<body>
			...
			<s:if test="#request.orderid!=''">
				...
				<tr>
					<td align="center" colspan="6">
									<button id="btn_submit" type="button" style="width:150px;"
							onclick="prolongSeller();">延长买家收货时间</button></td>						
				</tr>
				...
				<hr width="900px">
				<tr>
					<td align="center" ><span style="color:#FF0000">*</span>延长天数（天）：	
