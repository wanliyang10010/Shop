...
<script type="text/javascript" src="${ctx}/js/prolongTime/prolongTime.js"></script>
						...
						<div class="col-md-10 col-xs-12">
							...
							<div class="row">
								...
								<div class="col-md-10">
									<div class="row">
										<div class="col-md-12">
											<h3 style="margin-left: 30%;"><B>延长收货时间</B></h3>
											...
											<s:iterator value="#request.order" status="s">	
											 ...
											 <fieldset id="prolongFieldset">
						                      <legend>延长天数</legend>
						                       <div class="form-group" >
						                          <label class="col-md-2 control-label padding-right-0" for="dayapply">
						                          	 	<font color="red" size="3">*</font>延长天数（天）：</label>
						                          <div class="col-md-8">
						                             <input class="form-control" id="dayapply" name="dayapply" type="text" placeholder="延长天数"
						                             maxlength="2" onkeyup="var myreg=/^[0-9]+$/;if(!myreg.test(this.value)){this.value=''; };"/>
						                          </div>
						                       </div>
						                    </fieldset>  
						                     	<div class="col-md-12" >
